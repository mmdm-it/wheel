#!/usr/bin/env python3
"""
Populate Job (42 chapters, ~1070 verses) with all 9 languages.
"""
...
CHAPTERS_DIR = PROJECT_ROOT / "data" / "gutenberg" / "chapters" / "IOB"
...
# Job chapter files (42 chapters)
# NAB: __PEM.HTM (ch1) - EM in base36 = 14*36+22 = 526
# Spanish: __PKC.HTM (ch1) - KC = 20*36+12 = 732
# Italian: __PDU.HTM (ch1) - DU = 13*36+30 = 498
NAB_JOB = generate_base36_files("EM", NUM_CHAPTERS)
SPANISH_JOB = generate_base36_files("KC", NUM_CHAPTERS)
ITALIAN_JOB = generate_base36_files("DU", NUM_CHAPTERS)
...
def main():
    print("=" * 60)
    print("Populating Job with 9 Languages")
    print("=" * 60)
    ...
    nab_files = {ch: nab_dir / fname for ch, fname in NAB_JOB.items()}
    ...
    spanish_files = {ch: spanish_dir / fname for ch, fname in SPANISH_JOB.items()}
    ...
    italian_files = {ch: italian_dir / fname for ch, fname in ITALIAN_JOB.items()}
    ...
    print(f"\n✅ Job complete! {total_updates} translations added.")
