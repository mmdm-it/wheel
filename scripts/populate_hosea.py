#!/usr/bin/env python3
"""
Populate Hosea (14 chapters) with all 9 languages.
"""
...
CHAPTERS_DIR = PROJECT_ROOT / "data" / "gutenberg" / "chapters" / "OSE"
...
# Hosea chapter files (14 chapters)
# NAB: __PT1.HTM (ch1) - T1 = 29*36+1 = 1045
# Spanish: __PEB.HTM (ch1) - EB = 14*36+11 = 515
# Italian: __PRU.HTM (ch1) - RU = 27*36+30 = 1002
NAB_HOS = generate_base36_files("T1", NUM_CHAPTERS)
SPANISH_HOS = generate_base36_files("EB", NUM_CHAPTERS)
ITALIAN_HOS = generate_base36_files("RU", NUM_CHAPTERS)
...
def main():
    print("=" * 60)
    print("Populating Hosea with 9 Languages")
    print("=" * 60)
    ...
    nab_files = {ch: nab_dir / fname for ch, fname in NAB_HOS.items()}
    ...
    spanish_files = {ch: spanish_dir / fname for ch, fname in SPANISH_HOS.items()}
    ...
    italian_files = {ch: italian_dir / fname for ch, fname in ITALIAN_HOS.items()}
    ...
    print(f"\n✅ Hosea complete! {total_updates} translations added.")
