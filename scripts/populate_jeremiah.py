#!/usr/bin/env python3
"""
Populate Jeremiah (52 chapters, ~1364 verses) with all 9 languages.
"""
...
CHAPTERS_DIR = PROJECT_ROOT / "data" / "gutenberg" / "chapters" / "IERE"
...
# Jeremiah chapter files (52 chapters)
# NAB: __PPF.HTM (ch1) - PF in base36 = 25*36+15 = 915
# Spanish: __PBH.HTM (ch1) - BH = 11*36+17 = 413
# Italian: __POD.HTM (ch1) - OD = 24*36+13 = 877
NAB_JER = generate_base36_files("PF", NUM_CHAPTERS)
SPANISH_JER = generate_base36_files("BH", NUM_CHAPTERS)
ITALIAN_JER = generate_base36_files("OD", NUM_CHAPTERS)
...
def main():
    print("=" * 60)
    print("Populating Jeremiah with 9 Languages")
    print("=" * 60)
    ...
    nab_files = {ch: nab_dir / fname for ch, fname in NAB_JER.items()}
    ...
    spanish_files = {ch: spanish_dir / fname for ch, fname in SPANISH_JER.items()}
    ...
    italian_files = {ch: italian_dir / fname for ch, fname in ITALIAN_JER.items()}
    ...
    print(f"\n✅ Jeremiah complete! {total_updates} translations added.")
