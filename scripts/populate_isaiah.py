#!/usr/bin/env python3
"""
Populate Isaiah (66 chapters, ~1292 verses) with all 9 languages.
"""
...
CHAPTERS_DIR = PROJECT_ROOT / "data" / "gutenberg" / "chapters" / "ISA"
...
# Isaiah chapter files (66 chapters)
# NAB: __PNK.HTM (ch1) - NK in base36 = 23*36+20 = 848
# Spanish: __P9L.HTM (ch1) - 9L = 9*36+21 = 345
# Italian: __PMJ.HTM (ch1) - MJ = 22*36+19 = 811
NAB_ISA = generate_base36_files("NK", NUM_CHAPTERS)
SPANISH_ISA = generate_base36_files("9L", NUM_CHAPTERS)
ITALIAN_ISA = generate_base36_files("MJ", NUM_CHAPTERS)
...
def main():
    print("=" * 60)
    print("Populating Isaiah with 9 Languages")
    print("=" * 60)
    ...
    nab_files = {ch: nab_dir / fname for ch, fname in NAB_ISA.items()}
    ...
    spanish_files = {ch: spanish_dir / fname for ch, fname in SPANISH_ISA.items()}
    ...
    italian_files = {ch: italian_dir / fname for ch, fname in ITALIAN_ISA.items()}
    ...
    print(f"\n✅ Isaiah complete! {total_updates} translations added.")
