...
## Release Train
- v3.7.26 Baseline data + UI lift — done
- v3.7.26 Adapter + state-store foundation — done
- v3.7.26 Volume-safe interaction loop — done
- v3.7.26 Detail/pyramid rebuild on adapters — done
- v3.7.26 Theming + accessibility hardening — done (theming tokens, a11y pass, perf budgets, theme swap smoke)
- v3.7.26 Dimension System (lens: language/time) — shipped: language + edition portals, schema/adapter hydration, UI cycling with aria/keyboard, perf budgets
