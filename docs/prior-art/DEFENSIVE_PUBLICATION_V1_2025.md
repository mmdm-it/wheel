> **Editor's note (2026-07-18, added on reproduction — the body below is a
> verbatim copy of the original November 2025 document as published in git
> commit `ca19d84`).** The original expands "MMdM" as "Motori Marini di
> Montagna." That expansion is **erroneous** — it does not name the
> organization and was never used by it. The correct name is **Meccanismi
> Marittimi delle Marche** (Fano, PU, Italy). The acronym MMdM is correct
> throughout; only its long-form gloss is wrong. See
> `DEFENSIVE_PUBLICATION_V2_2026.md` §0. The body is left unaltered to
> preserve it as a faithful reproduction of the dated original.
